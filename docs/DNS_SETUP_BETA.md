# Hướng Dẫn Cấu Hình DNS cho beta.thelab.tulie.vn

## Tổng Quan
Hiện tại `beta.thelab.tulie.vn` đang point đến Vercel. Chúng ta cần map domain này sang Cloud Run service `academy-web-beta`.
...
beta.thelab.tulie.vn    AAAA    2001:4860:4802:32::15
beta.thelab.tulie.vn    AAAA    2001:4860:4802:34::15
beta.thelab.tulie.vn    AAAA    2001:4860:4802:36::15
beta.thelab.tulie.vn    AAAA    2001:4860:4802:38::15
```
...
Xóa các records hiện tại của `beta.thelab.tulie.vn` đang point đến Vercel:
...
2. Xóa domain `beta.thelab.tulie.vn` khỏi Vercel project
...
```bash
gcloud run domain-mappings delete beta.thelab.tulie.vn --region asia-southeast1
```
...
- Kiểm tra trên nhiều DNS server: `dig @8.8.8.8 beta.thelab.tulie.vn`
...
- DNS propagation: https://dnschecker.org (nhập `beta.thelab.tulie.vn`)
