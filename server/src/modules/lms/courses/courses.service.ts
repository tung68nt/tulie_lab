...
export class CourseService {
    ...
    async createCourse(data: any) {
        const validFields = ['title', 'slug', 'description', 'price', 'compareAtPrice', 'isPublished', 'instructorId', 'categoryId', 'thumbnail', 'introVideoUrl', 'learningOutcomes', 'deploymentStatus', 'tag', 'structure', 'addOnIds', 'saleStartDate', 'saleEndDate', 'releaseDate'];
