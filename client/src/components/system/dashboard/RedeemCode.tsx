        ...
        <div className="bg-white/50 backdrop-blur-sm p-6 rounded-2xl border border-dashed border-primary/20 shadow-sm mb-8 animate-in fade-in slide-in-from-top-4 duration-500">
            <div className="flex flex-col md:flex-row md:items-center gap-6">
                ...
                <div className="flex gap-2 w-full md:w-auto">
                    <input
                        className="flex-1 md:w-64 h-11 rounded-xl border border-input bg-background px-4 text-sm focus:ring-2 focus:ring-primary/20 transition-all outline-none uppercase font-mono tracking-wider"
