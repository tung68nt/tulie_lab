    ...
    return (
        <>
            ...
            <div className="absolute top-4 left-[60px] z-30">
                <div className="flex items-center gap-2 px-3 h-[38px] bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-lg shadow-sm box-border">
