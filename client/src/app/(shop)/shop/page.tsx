...
import { Search, Filter, X, ChevronRight, Calculator, Users, TrendingUp, Briefcase, Palette, Folder, Layout, Code, Key, Zap, Package, Layers } from 'lucide-react';
        ...
        <div className="min-h-screen pt-12 md:pt-16 pb-20 bg-background relative overflow-hidden">
            ...
            <div className="container relative z-10">
                ...
                <div className="flex flex-col lg:flex-row gap-12">
                    ...
                    <aside className={`w-full lg:w-72 shrink-0 space-y-5 lg:sticky lg:top-24 lg:self-start ${showMobileFilter ? 'block' : 'hidden lg:block'}`}>
                        {/* Search Bar */}
                        ...
                        {/* Categories List */}
                        <div className="space-y-2">
                            <h3 className="text-sm font-bold text-muted-foreground/80 px-2">Lĩnh vực</h3>
                        ...
                        {/* Product Types */}
                        <div className="space-y-2">
                            <h3 className="text-sm font-bold text-muted-foreground/80 px-2">Loại hình</h3>
                            <nav className="flex flex-col gap-0.5">
                                                        ...
                                                        <Badge className="bg-background/80 backdrop-blur-md border border-white/20 text-foreground py-1 px-3 text-xs capitalize flex items-center gap-1.5">
                                                            {(() => {
                                                                switch (product.type) {
                                                                    ...
                                                                    case 'APP': return <Code className="w-3 h-3" />;
                                                                    case 'LICENSE': return <Key className="w-3 h-3" />;
                                                                    case 'SUBSCRIPTION': return <Zap className="w-3 h-3" />;
                ...
                <div className="relative rounded-3xl bg-[#141414] p-12 md:p-16 overflow-hidden text-center md:text-left border border-white/5 shadow-2xl">
                    ...
                    <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-12">
                        <div className="max-w-2xl text-left">
                            <h2 className="text-3xl md:text-5xl font-bold text-white mb-8 leading-[1.8] tracking-normal">
                                Bạn cần giải pháp <br /> <span className="text-zinc-500">thiết kế riêng biệt?</span>
                            </h2>
