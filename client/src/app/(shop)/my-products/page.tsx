            ...
            <div className="p-6 flex flex-col flex-1">
                ...
                <div className="mt-auto space-y-3">
                    ...
                    <div className="flex gap-3">
                        {downloadUrl ? (
                            <a href={api.getMediaUrl(downloadUrl)} target="_blank" rel="noopener noreferrer" className="flex-1">
                            ...
                            <Button disabled className="flex-1 w-full font-bold rounded-xl bg-muted text-muted-foreground cursor-not-allowed">
                                <svg className="w-4 h-4 mr-2 opacity-50" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" /></svg>
                                Chưa có file
                            </Button>
                        )}
